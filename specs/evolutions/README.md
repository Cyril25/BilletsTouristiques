...
| [#62 (prod)](demande-62-migration-email-membre.md) | Migrer un membre vers une nouvelle adresse email ([en clair](demande-62-migration-email-membre-en-clair.md)) | L | En cours (dev) — étapes 0 et 1 prêtes et éprouvées sur banc (site de l'étape 0 : `333b89b`) ; migrations à jouer par Cyril ; étapes 2 à 5 à écrire | ✅ | `333b89b` |
