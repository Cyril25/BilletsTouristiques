...
| [#62 (prod)](demande-62-migration-email-membre.md) | Migrer un membre vers une nouvelle adresse email ([en clair](demande-62-migration-email-membre-en-clair.md)) | L | En cours (dev) — étapes 0 et 1 **en production** le 17/09 (contrôles 8/8 et 20/20 ; site de l'étape 0 : `333b89b`) ; étape 2 (règles d'accès) **en production** le 18/09 ; étapes 3 à 5 à écrire | ✅ | `333b89b` |
