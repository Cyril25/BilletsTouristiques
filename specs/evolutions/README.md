...
| [#62 (prod)](demande-62-migration-email-membre.md) | Migrer un membre vers une nouvelle adresse email ([en clair](demande-62-migration-email-membre-en-clair.md)) | L | En cours (dev) — étapes 0 et 1 **en production** le 17/09 (contrôles 8/8 et 20/20 ; site de l'étape 0 : `333b89b`) ; étapes 0 à 2 **en production** ; étapes 0 à 2 **en production** ; étape 3 : groupes 1 à 5 en ligne (`b0fb923`, `a6d6452`, correctif `6deb74c`), groupe 6 `mes-collectes.js` prêt ; étape 4 écrite et éprouvée au banc | ✅ | `333b89b` |
