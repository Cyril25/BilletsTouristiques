...
| [#1](demande-1-vente-du-rab.md) | Vente du rab / numéros spéciaux (collecteur) ([en clair](demande-1-vente-du-rab-en-clair.md)) | L | **Analyse à valider** — reprise le 14/09 d'après Jean-Philippe : le rab mis en vente, attribution directe à confirmer par Cyril ([cadrage commun](demande-22-et-1-cadrage-doubles-et-vente.md)) | ✅ | — |
