...
| [#22](demande-22-tableau-doubles-recherches.md) | Doubles, ventes et echanges entre membres (3 lots) | L | **Analyse à valider** — reprise le 11/09 ; le 14/09, ses annonces s'appuieront sur la mise en vente de #1 ([cadrage commun](demande-22-et-1-cadrage-doubles-et-vente.md)) | ✅ | — |
| [#1](demande-1-vente-du-rab.md) | Vente du rab / numéros spéciaux (collecteur) ([en clair](demande-1-vente-du-rab-en-clair.md)) | L | **Analyse à valider** — reprise le 14/09 d'après Jean-Philippe : le rab mis en vente, attribution directe et ordre des travaux tranchés par Cyril — validable ([cadrage commun](demande-22-et-1-cadrage-doubles-et-vente.md)) | ✅ | — |
| [#63](demande-63-carte-membres-stats.md) | Carte des membres sur la page Statistiques ([en clair](demande-63-carte-membres-stats-en-clair.md)) | M | À tester — **migration + rattrapage à jouer d'abord** | ✅ | `8572c0b` |
...
| [#62 (prod)](demande-62-migration-email-membre.md) | Migrer un membre vers une nouvelle adresse email ([en clair](demande-62-migration-email-membre-en-clair.md)) | L | À tester — étapes 0 et 1 **en production** le 17/09 (contrôles 8/8 et 20/20 ; site de l'étape 0 : `333b89b`) ; étapes 0 à 2 **en production** ; **les 6 étapes sont faites** (20/09) : numéros en base, règles d'accès, les 12 écrans, adresses recopiées retirées, et l'écran « Changer l'adresse / Désactiver / Réactiver » | ✅ | `ed4cb0a` |
...
| [#66 (prod)](demande-66-verification-billets-import.md) | Fiabiliser les versions des billets : import d'un fichier externe et écran de vérification ([en clair](demande-66-verification-billets-import-en-clair.md)) | L | À tester — écran « Qualité des billets » avec #69, migration jouée le 15/09 (contrôle 13/13) | ✅ | `186492a` + `d0e941d` |
...
| [#69 (prod)](demande-69-incoherences-billets.md) | L'écran « Incohérences des billets » : un catalogue de contrôles et un lien vers chaque fiche ([en clair](demande-69-incoherences-billets-en-clair.md)) | L | À tester — écran « Qualité des billets » avec #66, migration jouée le 15/09 (7 176 constats) | ✅ | `d0e941d` |
...
| [#72 (prod)](demande-72-veille-comptes-inactifs.md) | Mettre en veille les comptes inactifs, faire compléter les fiches ([en clair](demande-72-veille-comptes-inactifs-en-clair.md)) | L | En cours — lots 1 à 3 en ligne (migration jouée le 24/09) ; à tester quand le lot 4 (automatisme) le sera, après Q2/Q3 | ✅ | `1d367c4` |
