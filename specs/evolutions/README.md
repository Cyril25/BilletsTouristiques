...
| [#62 (prod)](demande-62-migration-email-membre.md) | Migrer un membre vers une nouvelle adresse email ([en clair](demande-62-migration-email-membre-en-clair.md)) | L | Analyse à valider — réponses de Cyril le 14/09 : suppression → désactivation ; reste le garde-fou | ✅ | — |
...
| [#66 (prod)](demande-66-verification-billets-import.md) | Fiabiliser les versions des billets : import d'un fichier externe et écran de vérification ([en clair](demande-66-verification-billets-import-en-clair.md)) | L | Analyse à valider — écrite sans exemple d'export | ✅ | — |
